...
class mandatoryShopSetting
{
    static function mandatoryElements()
    {
        ...
        define('EMAIL_ADMIN',     'vitalyyou@gmail.com,you@mkr.com.ua,toltecos@ukr.net,toltecos.ua@gmail.com');
        define('EMAIL_FEEDBACK',  'vitalyyou@gmail.com,you@mkr.com.ua,toltecos@ukr.net,toltecos.ua@gmail.com');
...
if($_SESSION['lang']=="en"){
	...
	define('SITE_NAME', 'Olda');
	define('SITE_NAME_FULL', 'Olda');
        define('META_T_DEFAULT', 'Olda');
        define('META_K_DEFAULT', 'Olda');
        define('META_D_DEFAULT', 'Olda');

// Mandatory
    define('MANDATORY_BREAD_CRUMBS_FIRST', 'Home');
...
elseif($_SESSION['lang']=="ru"){
	define('SITE_NAME', 'Олда');
	define('SITE_NAME_FULL', 'Олда - строительные материалы в Киве: кирпич, газобетон, пеноблоки, черепица, оконные системы');
    define('META_T_DEFAULT', 'Продажа стройматериалов Газоблок Киев, кирпич  в Киеве, купить  кирпич, Кирпич Киев, Газобетон Бровары, Газобетонные блоки');
    define('META_K_DEFAULT', 'Газоблок купить, кирпич, газобетонные блоки, кирпич цена, Газоблок Киев, газблоки цена, кирпич в Киеве, газоблок купить, кирпич киев, газобетон стимость кирпича Кирпич 100 кирпич купить газобетон цена, газобетон, газобетон купить, газобетон цена, газобетон стоунлайт, газоблок, газоблок аэрок, газоблок аэрок купить, газоблок аэрок цена, газоблок бровары, газоблок бровары цена, газоблок купить, газоблок стоунлайт, газоблок стоунлайт цена, газоблоки, газоблоки цена, кирпич в киеве, кирпич киев, кирпич клинкерн');
    define('META_D_DEFAULT', 'Огромный выбор кирпича керамический, облицовочный, клинкерный; газоблок бровары,газоблок стоунлайт,газоблок аерок, пеноблоки цена,сухие строительные смеси, тротуарная плитка, цемент, металлопластиковые окна.');

// Mandatory
    define('MANDATORY_BREAD_CRUMBS_FIRST', 'Олда');
...
// /Mandatory
    ...
    define('MANDATORY_NOTE_IN_CART','В рюкзак');
...
// /General
    ...
    define('NOTE_ARTICLES','Статьи');
        ...
        define('MANDATORY_SEARCH_DEVIZ','Кто ищет, тот всегда..');
	...
	define('SITE_NAME', 'Олда');
	define('SITE_NAME_FULL', 'Олда');
    define('META_T_DEFAULT', 'Олда');
    define('META_K_DEFAULT', 'Олда');
    define('META_D_DEFAULT', 'Олда');

// Mandatory
    
    define('MANDATORY_BREAD_CRUMBS_FIRST', 'Домой');
